...
![winServConf.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/winServConf.jpg)

I will also change hostname of the computer in settings, which will trigger a restart.

![winServHostname.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/winServHostname.jpg)
...
![serverManagerPostInstall.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/serverManagerPostInstall.jpg)

Start by hitting *Promote this server to a domain controller*.

Add a new forest and enter the domain you've been using.

![ADDomain.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/ADDomain.jpg)

Enter the login credentials for the Administrator user and continue with default settings until the end.

![ADDomain2.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/ADDomain2.jpg)

After installation, the computer will restart automatically and you should see your domain on the login screen now.

![winServLogin.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/winServLogin.jpg)
...
![winServDHCP.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/winServDHCP.jpg)

Now enter the name for the network with a description.

![winServDHCP2.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/winServDHCP2.jpg)
...
![winServDHCP3.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/winServDHCP3.jpg)
...
![winServDHCP4.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/winServDHCP4.jpg)
...
![reverseLookupZone.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/reverseLookupZone.jpg)
...
![newDNSEntry.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/newDNSEntry.jpg)
...
![newDNSEntry2.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/newDNSEntry2.jpg)

A quick nslookup command lets us check that these changes are working.

![nslookupWinServ.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/nslookupWinServ.jpg)
...
![remoteAccess.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/remoteAccess.jpg)
...
![passwordSettings1.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/passwordSettings1.jpg)
...
![passwordSettings2.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/passwordSettings2.jpg)
...
![groups.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/groups.jpg)
...
![newUser.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/newUser.jpg)
...
![localAdmin1.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/localAdmin1.jpg)
...
![localAdmin2.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/localAdmin2.jpg)
...
![sharedFolder.jpg failed to load]({{ site.baseurl }}/assets/images/homelab/buildPart5/sharedFolder.jpg)
